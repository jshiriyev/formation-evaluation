...
sys.path.append(r'C:\Users\User\Documents\GitHub\lasview')
...
class DepthView():
    ...
    def set_depths(self,top,bottom,base=10,subs=1,subskip=None,subskip_top=0,subskip_bottom=0):
        ...
        self.depths['ticks'] = ticker.MultipleLocator(base).tick_values(top,bottom)
